...
bottom_rows <- 
  testsheet_df$row[ testsheet_df$data_type == "character" & 
                    str_detect(testsheet_df$character,"Average RSE")]

top_rows <- 
  testsheet_df$row[ testsheet_df$data_type == "character" & 
                    str_detect(testsheet_df$character,"^Table")]

orientated_df_auto <-  
  orientate_auto(table_range = ~ row < min(anchor_rows),
