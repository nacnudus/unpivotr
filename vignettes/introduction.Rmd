...
tidied <-
  ...
  behead_if(indent[local_format_id] == 0,
            ...
            name = "location") %>%
  behead("left", "subject") %>%
  dplyr::select(address, dormitory, name, location, subject, mark = numeric) %>%
  dplyr::arrange(dormitory, name, location, subject)
...
cells <-
  ...
  dplyr::select(row, col, is_blank, data_type, character, numeric, local_format_id)
...
cells %>%
  ...
  behead_if(indent[local_format_id] == 0,
            ...
            name = "location") %>%
  behead("left", "subject") %>%
  dplyr::select(dormitory, name, location, subject, mark = numeric, other = character)
```
