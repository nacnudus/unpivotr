...
There are four directions to resolve this: `"ABOVE"`, `"LEFT"`, `"BELOW"` and
...
data_cells %>%
  enhead(first_header_row, "ABOVE", corner_cells = first_header_row_corners) %>%
  enhead(second_header_row, "N") %>%
  enhead(first_header_col, "LEFT", corner_cells = first_header_col_corners) %>%
  enhead(second_header_col, "W") %>%
  select(-row, -col)
```
