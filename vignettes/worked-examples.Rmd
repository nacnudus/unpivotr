...
* `corner_cells` is the cells whose position is in one corner of the domain of the
...
data_cells %>%
  ABOVE(first_header_row, corner_cells = first_header_row_corners) %>%
  N(second_header_row) %>%
  LEFT(first_header_col, corner_cells = first_header_col_corners) %>%
  W(second_header_col) %>%
  select(-row, -col)
```
